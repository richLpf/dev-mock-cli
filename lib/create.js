...
module.exports = async function create (projectName) {
  ...
  //console.log("bolierplateType", bolierplateType)

  const remoteUrl = TPL_TYPE[templateType]
  console.log(logSymbols.success, `Creating template of project ${templateType} in ${targetDir}`)
    ...
    fs.readFile(`./${projectName}/package.json`, 'utf8', function (err, data) {
      ...
      fs.writeFile(`./${projectName}/package.json`, updatePackageJson, 'utf8', function (err) {
        ...
        if (err) {
          ...
          console.log(logSymbols.success, chalk.green(`Successfully created project template of ${templateType}\n`))
